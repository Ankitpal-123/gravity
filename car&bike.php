...
<body>
    ...
    <div class="header_section">
        ...
        <h1 style="display: flex; margin-top: 70px;justify-content: center; font-size: xx-large; font-weight: bolder;">
            Car carriers & Bike</h1>
        ...
        <div class="about_section layout_padding">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <div><img src="./img/car&bike.png" class="image_8"></div>
                    </div>
                    <div class="col-sm-6">
                        <h1 class="lorem_text">Efficient Car Transportation Services</h1>
                        <p>Are you moving to a new location and wish to transport your vehicle to that place? Then
                            Gravity packers and movers are the right choice for vehicle transportation. We provide our
                            clients with transportation services for cars and bikes. You may not be able to drive to
                            your new area due to the long distance. In such cases, we offer you expert services for
                            transportation of vehicles.</p>
                        <p>Don't wait and get the best packers movers in Bangalore Services with us now</p>
                        <p>Professional Car Packers and Movers in Bangalore</p>
                        <p>We at Gravity packers and movers have been in the business of packing and moving goods for
                            more than 6 years. With time, we have become quite proficient in our services and have been
                            able to gain a complete understanding of our clients.</p>
                        <p>Gravity packers and movers offer the most reliable and efficient car carrier service. We
                            handle the car with utmost care so that it is free of any scars. Safety is our first
                            priority while relocating your car from one place to another. We are proud to have specially
                            designed trailers and trucks for the safe and sound transportation of your cars. With the
                            help of these specially designed trailers and trucks, we assure ideal packing and moving for
                            your cars in India. Various car trailers are utilized from our side to ensure effective and
                            timely door-to-door delivery.</p>
                    </div>
                </div>
            </div>
        </div>
