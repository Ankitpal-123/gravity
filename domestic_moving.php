...
<body>
    ...
    <div class="header_section">
        ...
        <h1 style="display: flex; justify-content: center; font-size: xx-large; font-weight: bolder; margin-top: 70px;">
            Domestic
            shifting</h1>
        ...
        <div class="about_section layout_padding">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <div><img src="./img/Domestic shifting .jpg" class="image_8"
                                style="margin-top: 10px; height: 300px;"></div>
                    </div>
                    <div class="col-sm-6">

                        <p>When it comes to domestic packers and movers, we provide excellent services in this field
                            that
                            makes us the best choice in domestic shifting. It becomes quite hectic to transport your
                            household,
                            storage, warehouse, and office belongings from one state to another and also from one
                            location to
                            another in the same city and we give you hasslefree domestic relocation services making your
                            life
                            easier in many ways. You just have to share your requirements related to your relocation and
                            you
                            just have to sit and relax as everything else will be taken care of by us.
