...
<body>
    ...
    <div class="header_section">
        ...
        <h1 style="display: flex; justify-content: center; font-size: xx-large; font-weight: bolder;">International
            shifting</h1>
        ...
        <div class="about_section layout_padding">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <div><img src="./img/International shifting .jpg" class=" image_8" style="margin-top: 10px;">
                        </div>
                    </div>
                    <div class="col-sm-6">

                        <p>International shifting is among the pioneers in India's payload space, offering the snappiest
                            and most secure way to deal with passing on the product inside the submitted movement time,
                            to any part of the country, with smoothed out and keen game plans. Considering extensive
                            stretches of association, we have enormous fitness in contribution to strong air Services.
                            Following a deliberate framework, all the procedures are meticulously driven
                            straightforwardly from the ability to the transport of the heap. In like manner, we have
                            advanced track and follow systems, so the clients can eagerly screen the improvement of the
                            payload.</p>
